...
const handle = new Promise( function(resolve, reject) {
  ...
  setTimeout( function() {
    ...
    resolve(); // 5. 첫번째 Promise가 fulfilled(이행한) 상태가 됩니다
  }, 3000);
})
.then(function() {
  // 6.첫번째 Promise가 완료되고, 두 번째 Promise가 시작됩니다.
...
.then(function() {
  // 10. 두번째 Promise가 완료되고, 세번째 Promise가 시작됩니다
  return new Promise(function(resolve,reject) {
    setTimeout(function() {
      console.log('세번째'); // 12
      resolve(); //13
...
// 3.  3초의 대기가 시작됩니다
// 7.  첫번째 Promise가 완료되었으며, 두번째 Promise의 2초 대기가 시작됩니다
// 11. 두번째 Promise가 완료되었으며, 세번째 Promise의 1초 대기가 시작됩니다
